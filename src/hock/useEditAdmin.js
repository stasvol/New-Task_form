...
export const useEditAdmin = (getTaskThunkCreator,currentPage,totalCount,text, status, sort,changeSortAll,id, index,
                             ) => {
    ...
    return { editStatus, setEditStatus, editText, setEditText, handleChangeText, handleChangeStatus, handleClick }
