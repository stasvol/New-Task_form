...
// import {addTaskThunk, addUserTask,
// getTask, getTaskThunkCreator} from "../store/addTask-reducer";
...
//              text:values.text,
//          }
//          props.addTaskThunk(users,props.currentPage,props.totalCount,props)
//          setSubmitting(false);
//         console.log(users)
//     }
//
...
//  !dirty && !isSubmitting}>Submit</button>
//                 </div>
//
//             </Form>
//
...
// props.message.tasks.map(el=> <div style={{display:"flex",
// border: '1px solid black',padding: 10,  margin:10, width:400}}
// key={el.id}>Name:{el.username}  <br/> Email: {el.email}
// <br/>Text: {el.text} <br/>Status: {el.status}
//           <img style={{marginLeft:50}}
//           width={100} src={el.image_path}/></div>)
//       }
//
//       <MyPagination/>
//       <Entrance_admin/>
...
// {getTaskThunkCreator,addTaskThunk})(TasksUsers) ;
